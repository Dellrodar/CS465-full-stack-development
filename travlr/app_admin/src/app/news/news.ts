...
// News page ported from the original static site. Content is static
// for now since there is no news endpoint in the API
@Component({
  selector: 'app-news',
  imports: [],
...
export class News {
  ...
  // Sidebar links only anchor to the current page for now
